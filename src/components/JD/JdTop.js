        ...
        <div className="row">
          <div className="col-xl-12 col-lg-12">
            <div className="section-title text-center ml-50 mr-50 mb-80">
              ...
              <h1>
                Hiện tại chúng tôi đang cần tuyển <span>05</span> kỹ sư phát triển Front-End cho sản phẩm.
              </h1>
            </div>
            <span className="border-left-1"></span>
          </div>
          <div className="col-xl-12 col-lg-12">
            ...
            <div className="it-management-text mb-60">
              <h4>Lưu ý</h4>
              <span>
                Bạn không nhất thiết phải biết hết các công nghệ này trước khi ứng tuyển vào vị trí Front-End Developer. Tuy nhiên, bạn sẽ được đào
                tạo và sử dụng những công nghệ mới nhất này trong quá trình làm việc với chúng tôi!
              </span>
            </div>
          </div>
        </div>
